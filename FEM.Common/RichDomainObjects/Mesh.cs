...
using FEM.Shared.Domain.YamlModels;

namespace FEM.Common.RichDomainObjects;
...
public class Mesh
{
    ...
    public async Task ResolveMesh()
    {
        ...
        var additionalParameters
            = await _yamlParser.ParseEntityFromFile<AdditionalParameters>(_directories["additionalParameters"]);
