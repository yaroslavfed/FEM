...
/// <inheritdoc cref="IStationaryVisualizerService"/>
public class StationaryVisualizerService : IStationaryVisualizerService
{
    private readonly IStationarySaverService _saverService;
    ...
    /// <inheritdoc cref="StationaryVisualizerService" />
    public StationaryVisualizerService(IStationarySaverService saverService)
    {
