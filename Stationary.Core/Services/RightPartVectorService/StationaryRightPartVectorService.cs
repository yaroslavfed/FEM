...
/// <inheritdoc cref="IStationaryRightPartVectorService"/>
public class StationaryRightPartVectorService : IStationaryRightPartVectorService
{
    private readonly IProblemService     _problemService;
    private readonly IMassMatrix<Matrix> _massMatrix;

    public StationaryRightPartVectorService(IProblemService problemService, IMassMatrix<Matrix> massMatrix)
    {
        _problemService = problemService;
        _massMatrix = massMatrix;
    }

    /// <inheritdoc cref="IStationaryRightPartVectorService.GetRightPartVectorAsync"/>
